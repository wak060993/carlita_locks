 ...
 */
final class Version20260612174243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture ADD montant_paye NUMERIC(10, 2) DEFAULT NULL, ADD reste_apayer NUMERIC(10, 2) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP montant_paye, DROP reste_apayer');
