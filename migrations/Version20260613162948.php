 ...
 */
final class Version20260613162948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prestation_produit (id INT AUTO_INCREMENT NOT NULL, quantite_utilisee INT NOT NULL, prestation_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_EA331FBE9E45C554 (prestation_id), INDEX IDX_EA331FBEF347EFB (produit_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE prestation_produit ADD CONSTRAINT FK_EA331FBE9E45C554 FOREIGN KEY (prestation_id) REFERENCES prestation (id)');
        $this->addSql('ALTER TABLE prestation_produit ADD CONSTRAINT FK_EA331FBEF347EFB FOREIGN KEY (produit_id) REFERENCES produit (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation_produit DROP FOREIGN KEY FK_EA331FBE9E45C554');
        $this->addSql('ALTER TABLE prestation_produit DROP FOREIGN KEY FK_EA331FBEF347EFB');
        $this->addSql('DROP TABLE prestation_produit');
